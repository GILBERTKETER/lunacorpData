                  ...
                  <div class="row g-3">
                    <div class="col-12">
                      <div class="form-group">
                        <input class="form-control" name="email_address" type="email" placeholder="Enter your Email Address" style="height: 40px;" />
                      </div>
                    </div>
                    <div class="col-12">
                      <div class="form-group">
                        <input class="form-control" name="password" type="password" placeholder="Enter your password" style="height: 40px;" />
                      </div>
                    </div>
                  </div>
                  <div class="row">
                    ...
                    <div class="col-lg-7 col-md-8 col-12">
                      <p><a href="forgotpassword.php" target="_blank">Forgot Password?</a> </p>
                      </p>
                    </div>
                  </div>
                  <p>
                    Please enter your credentials to login. If you dont have an account, you can sign up on our site <a style="color: #2196F3;" href="/signup.php">here</a>.
                  </p>
