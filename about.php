...
<body>
    ...
    <section class="pf-details section" style="width: 100vw !important;">
        <div style="width: 100vw !important;" class="container d-flex align-items-center justify-content-center" style="min-height: 400px;">
            <div style="width: 100vw !important;" class="row w-100">
                <div style="width: 100vw !important;" class="col-12 d-flex justify-content-center">
                    <div style="width: 100vw !important;" class="inner-content d-flex align-items-center w-100">
                        <div style="width: 100vw !important;" class="row w-100">
                            <!-- Image Column -->
                            <div style="width: 100vw !important;" class="col-lg-12 col-md-12 d-flex align-items-center justify-content-center flex-column">
                                <div style="width: 100vw !important; " class="appointment-image">
                                    <img style="height: 700px; width: 100vw !important;" src="img/slider2.jpg" alt="#" class="img-fluid" />
                                </div>
                            </div>
                            <!-- Form Column -->
                            <!-- <div class="col-lg-6 col-md-12 d-flex align-items-center justify-content-center"> -->
                            <section class="schedule" style="width:100vw !important;">
                                <div class="container">
                                                ...
                                                <div class="single-schedule first">
                                                    <div class="inner">
                                                        ...
                                                        <div class="single-content">
                                                            <span style="font-weight:bold; font-size: 20px; color: black; text-align:center;">Our Vision</span>
                                                            <!-- <h4>Real-Time Analysis</h4> -->
                                                            <p>
                                                                To shape a world where our alumni lead the vanguard of AI and data innovation, driving transformative changes that define the future of technology and society.
                                                            </p>
                                            ...
                                            <div class="col-lg-4 col-md-6 col-12">
                                                ...
                                                <div class="single-schedule middle">
                                                    <div class="inner">
                                                        ...
                                                        <div class="single-content">
                                                            <span style="font-weight:bold; font-size: 20px; color: black; text-align:center;">Our Mission </span>
                                                            <!-- <h4>Comprehensive Learning</h4> -->
                                                            <p>
                                                                Our mission is to forge the world's preeminent AI and data science leaders through our revolutionary, cutting-edge bootcamps. We transform ambitious learners into the most sought-after professionals who spearhead global innovation in AI and data science.
                                                            </p>
                                            ...
                                            <div class="col-lg-4 col-md-12 col-12">
                                                ...
                                                <div class="single-schedule last">
                                                    <div class="inner">
                                                        ...
                                                        <div class="single-content">
                                                            <span style="font-weight:bold; font-size: 20px; color: black; text-align:center;">Our Legacy of Excellence:
                                                            </span>
                                                            <!-- <h4>Comprehensive Learning</h4> -->
                                                            <p>
                                                                - Trailblazers in AI integration.<br>
                                                                - Revolutionized data visualization techniques adopted by Fortune 500 companies.<br>
                                                                - Pioneered practical applications of data science in business, creating industry standards
                                                            </p>
